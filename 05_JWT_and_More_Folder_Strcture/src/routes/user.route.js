...
import {getAllUser,createUser,deleteUser, kindOfLogin, getMyInfo} from "../controllers/router.controller.js"
...
// Get : to get user's info from stored token.
router.get("/getMe", getMyInfo)
